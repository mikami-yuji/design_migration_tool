...
python -m pip install "watchdog>=3.0.0" "pystray>=0.19.0" "Pillow>=10.0.0" "pypdfium2>=5.0.0" pyinstaller --no-warn-script-location
...
python -m PyInstaller --clean --onedir --windowed --noupx --name "%APP_NAME%" main.py
